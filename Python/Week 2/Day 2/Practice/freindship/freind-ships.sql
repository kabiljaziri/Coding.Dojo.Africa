SELECT * FROM freinships_schema.friendships;
SET SQL_SAFE_UPDATES=0;

INSERT INTO users (first_name,last_name) VALUES ('Amy','Giver'),('Eli','Byers'),('Marky','Mark'),('Kermit','The Frog'),('Big','Bird'),('Kabil','Jaziri');
...
SELECT user_id, COUNT(friend_id) AS friend_count FROM friendships
GROUP BY user_id 
ORDER BY friend_count DESC;

SELECT user2.first_name , user2.last_name FROM friendships
